...
if dataset_name == "Math23K":
    ...
    var_nums = ['x','y']
    ckpt_dir = "ALG514_b2t_nosep_gumbel_15"
    ...
    for epoch in range(n_epochs):
        ...
        for idx in range(len(input_lengths)):
            ...
            for step in range(grad_acc_steps):
                ...
                #
                loss, stage1_loss, sent_acc, pro_acc, problem_len = train_lm2tree_v3(input_batches[idx][start_idx:end_idx],
        ...
        if epoch % 1 == 0 or epoch > n_epochs - 5:
            ...
            for test_batch in test_pairs:
                ...
                #print(test_batch['id'])
                #quantity_indicator
                test_res, test_sent_acc, test_pro_acc, test_problem_len = evaluate_lm2tree_v3(tokens_dict["input_ids"], 
                                               ...
                                               stage1_encoder, encoder, predict, generate,
