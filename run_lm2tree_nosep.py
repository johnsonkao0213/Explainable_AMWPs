...
if dataset_name == "Math23K":
    ...
    var_nums = ['x','y']
    ckpt_dir = "ALG514_b2t_pipeline_nosep4"
...
for fold in range(fold_num):
    ...
    for epoch in range(n_epochs):
        ...
        batch_dict = prepare_data_batch_origin_nosep(train_pairs, batch_size, lm_tokenizer=bert_tokenizer,
        ...
        if epoch % 1 == 0 or epoch > n_epochs - 5:
            ...
            for test_batch in test_pairs:
                ...
                for i, j in zip(sentence_m, test_batch['stage1_span']):
                    stage1_span_ids.extend([j] * len(i))
                
                stage1_span_ids.append(test_batch['stage1_span'][-1])
                ...
                test_res = evaluate_lm2tree(tokens_dict["input_ids"], len(tokens_dict["input_ids"]), tokens_dict["attention_mask"], tokens_dict["token_type_ids"], stage1_span_ids, generate_num_ids, encoder, predict, generate,
